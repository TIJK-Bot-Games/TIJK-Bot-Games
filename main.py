...
# Code from the TIJK-Bot repo has been used with consent of the owner codeman1o1.
...
if __name__ == "__main__":
    slash_files = os.listdir("slash")
    slash_files.remove("custom_checks.py")
    for slash in slash_files:
